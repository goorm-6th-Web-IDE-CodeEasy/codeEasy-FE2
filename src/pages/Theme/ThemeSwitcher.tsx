...
const ThemeSwitcher: React.FC = () => {
  ...
  return (
    <div>
      <div>
        <h2>라이트 모드</h2>
        <p>밝고 깨끗한 배경 위에 부드러운 색상의 조합을 사용하여 눈의 피로를 줄이고 가독성을 높입니다.</p>
        <input
          type="radio"
          id="light"
          name="theme"
      ...
      <div>
      <h2>다크 모드</h2>
      <p>눈부심을 최소화하며, 오랜 시간 동안의 작업에 적합하도록 만들어졌습니다.</p>
        <input
          type="radio"
          id="dark"
          name="theme"
      ...
      <div>
      <h2>고대비 모드</h2>
      <p>강렬한 색상 대비를 사용하여 요소를 뚜렷이 구분하며, 내용을 더욱 명확하게 전달할 수 있도록 설계되었습니다.</p>
        <input
          type="radio"
          id="highcontrast"
          name="theme"
