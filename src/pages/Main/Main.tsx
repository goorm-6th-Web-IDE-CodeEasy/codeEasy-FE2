...
import { MainAlgorithmSvg } from '../../components/Svg/MainAlgorithmSvg';
import ThemeSvg from '../../components/Svg/ThemeSvg';
import MainChatSvg from '../../components/Svg/MainChatSvg';
import MainFaqSvg from '../../components/Svg/MainFaqSvg';
import { SoundSvg } from '../../components/Svg/SoundSvg';
        ...
        <div className={styles.container}>
            ...
            <div className={styles.mainSection3}>
                <div className={styles.textContainer}>
                    ...
                    <p className={styles.text}>
                        음성기능을 활용하여, 소리를 통해서 알고리즘 문제를 해결하고 이해할 수 있습니다. CodeEasy에서는
                        모든 사용자가 효과적으로 학습하고 코딩 능력을 개발할 수 있도록 지원합니다.
                    </p>
                </div>
                <div className={styles.iconContainer}>
                    <div>
